...
namespace BookShopWinFrm.BusinessLayer
{
    public partial class FrmSale : Form
    {
        ...
        {
            InitializeComponent();
            this.VisibleChanged += FrmSale_VisibleChanged;
        }
        ...
        private void FrmSale_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                LoadData();
        ...
        private void ApplyPermissions()
        {
            ...
            foreach (DataRow row in this.UserPermissions.Rows)
            {
                ...
                if (permName == "SaleCreate")
                    btnAdd.Visible = true;
                else if (permName == "SaleModify")
                    btnEdit.Visible = true;
                else if (permName == "SaleDelete")
                    btnCancel.Visible = true;
            }
        }
        private void LoadData()
        {
            ...
            dgSales.Columns["RefNumber"].Width = 200;
