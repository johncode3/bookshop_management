...
namespace BookShopWinFrm.BusinessLayer
{
    public partial class FrmSaleAddEdit : Form
    {
        ...
        void LoadItem()
        {
            ...
            // Add empty row at the top for "No Selection"
            ...
            // Fix binding: the DataTable column is "ItemId" but the combo ValueMember is "ItemID"
            // We need to update the designer DataPropertyName to match
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (newsale)
            {
                ...
                if (saleid > 0)
                {
                    ...
                    {
                        // Skip rows with empty/null ItemId
